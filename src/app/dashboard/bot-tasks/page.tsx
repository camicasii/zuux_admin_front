        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-[#9fb8a8]">Manage Telegram bot game tasks.</p>
                </div>
                <div className="flex flex-col sm:flex-row gap-3 items-center">
                    <select
                        className="bg-[#0a1510] border border-[#1e3d2f] rounded-lg px-4 py-2 text-white text-sm focus:outline-none focus:border-[#4ade80] transition-colors"
                    ...
                    <table className="w-full text-left">
                        <thead className="bg-[#0a1510]/50 border-b border-[#1e3d2f]/50">
                            <tr>
                                ...
                                <th className="px-6 py-4 text-sm font-semibold text-[#9fb8a8]">Task Info</th>
                                <th className="px-6 py-4 text-sm font-semibold text-[#9fb8a8]">Campaign</th>
                                <th className="px-6 py-4 text-sm font-semibold text-[#9fb8a8] text-center">Points</th>
                        ...
                        <tbody className="divide-y divide-[#1e3d2f]/30">
                            {loading ? (
                                <tr>
                                    <td colSpan={6} className="px-6 py-12 text-center text-[#6b9b7f]">
                                        Loading tasks...
                                    </td>
                                </tr>
                                ...
                                filteredTasks.map((task) => {
                                    ...
                                    return (
                                        <tr key={task.id} className="hover:bg-[#0a1510]/20 transition-colors">
                                            ...
                                            <td className="px-6 py-4">
                                                ...
                                                <div className="text-sm text-[#6b9b7f] mt-1 max-w-sm truncate" title={task.url || ''}>
                                                    {task.url || 'No URL'}
                                                </div>
                                            </td>
                                            <td className="px-6 py-4 text-[#9fb8a8] text-sm">
                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
                    <div className="bg-[#0a1510] border border-[#1e3d2f] rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden">
                        ...
                        <form onSubmit={handleSave} className="p-6 space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-[#9fb8a8] mb-1">URL (Action Link)</label>
                                <input
                                    type="url"
                                    className="w-full bg-[#0f1f17] border border-[#1e3d2f] rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-[#4ade80] transition-colors"
                                    value={formData.url}
                            ...
                            <div>
                                <label className="block text-sm font-medium text-[#9fb8a8] mb-1">Campaign</label>
                                <select
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-sm font-medium text-[#9fb8a8] mb-1">Points</label>
                                    <input
                                        type="number"
                                        required
                                        className="w-full bg-[#0f1f17] border border-[#1e3d2f] rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-[#4ade80] transition-colors"
